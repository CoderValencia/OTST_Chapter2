...
Sprite_GalvVisRange.prototype.update = function() {
	...
	var xOff = 0;
	var yOff = 0;
	if($gamePlayer._direction == 4) xOff = -offsetValue;
	if($gamePlayer._direction == 6) xOff = offsetValue;
	if($gamePlayer._direction == 8) yOff = -offsetValue;
	if($gamePlayer._direction == 2) yOff = offsetValue;
	this.x = $gamePlayer.screenX() + xOff;
	this.y = $gamePlayer.screenY() - 24 + yOff;
